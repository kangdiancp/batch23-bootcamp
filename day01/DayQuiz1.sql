...
<<<<<<< HEAD
SELECT REGION_ID, COUNT(c.DEPARTEMENT_ID)
...
SELECT e.REGION_ID, (
	SELECT COUNT(a.DEPARTEMENT_ID)
	FROM DEPARTEMENTS a LEFT JOIN LOCATIONS b
		ON a.LOCATION_ID = b.LOCATION_ID 
		LEFT JOIN COUNTRIES c 
		ON b.COUNTRY_ID = c.COUNTRY_ID
			WHERE c.REGION_ID = e.REGION_ID ) AS TOTAL_DEPARTEMENT
=======
...
>>>>>>> 4b159e090ed521b8c9e8e5021bd480ea348584e1
			FROM REGIONS e;
...
<<<<<<< HEAD
	FROM JOBS a LEFT JOIN JOB_HISTORY b 
=======
	FROM JOBS a LEFT JOIN EMPLOYEES b 
>>>>>>> 4b159e090ed521b8c9e8e5021bd480ea348584e1
	ON a.JOB_ID = b.JOB_ID
...
<<<<<<< HEAD
SELECT a.DEPARTEMENT_NAME, COUNT(START_DATE) AS MASUK_KERJA
	FROM DEPARTEMENTS a INNER JOIN JOB_HISTORY b
	ON a.DEPARTEMENT_ID = b.DEPARTEMENT_ID
	GROUP BY a.DEPARTEMENT_NAME;
...
<<<<<<< HEAD
	ON a.JOB_ID = b.JOB_ID
		LEFT JOIN DEPARTEMENTS c
		ON b.DEPARTEMENT_ID = c.DEPARTEMENT_ID
...
SELECT e.JOB_ID, (
	...
	ON a.DEPARTEMENT_ID = b.DEPARTEMENT_ID
		LEFT JOIN JOB_HISTORY c
		ON b.JOB_ID = c.JOB_ID 
		WHERE a.DEPARTEMENT_ID = c.DEPARTEMENT_ID ) AS JUMLAH_MUTASI
		FROM JOBS e;
