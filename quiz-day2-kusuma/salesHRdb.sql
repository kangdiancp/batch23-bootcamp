--awal buat tabel itu cari dari yang ngga ada hubungan/join dg tael lain
--awal buat tabel dari tabel supplier
--lanjut ke buat tabel produk
--lanjut ke buat tabel kategori
--lanjut ke buat tabel order detail
--lanjut ke buat tabel order
--lanjut ke buat tabel customer
--lanjut ke buat tabel shipper
--terakhir ke buat tabel employees
...
INSERT INTO suppliers (supplier_id,company_name,contact_name,contact_title,addres,city,region,postal_code,country,phone,fax,homepage)
VALUES
...
INSERT INTO products (product_id,product_name,supplier_id,category_id,quantity_per_unit,unit_price,unit_in_stock,unit_in_order,reorder_level,discontinued)
VALUES
