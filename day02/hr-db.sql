...
alter table departments add constraint employee_id_fk foreign key (manager_id) references employees(employee_id)

alter table departments drop constraint employee_id_fk
alter table employees add column xemp_id integer
alter table departments drop column xemp_id
...
create table job_history (
	...
	foreign key (job_id) references jobs(job_id),
	foreign key (departments_id) references departments(departments_id),
	constraint employee_startdate_pk primary key (employee_id, start_date)
)
...
insert into departments (departments_id, departments_name, manager_id, location_id) values
...
insert into employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commision_pct, manager_id, departments_id, xemp_id) values
...
insert into job_history (employee_id, start_date, end_date, job_id, departments_id) values
